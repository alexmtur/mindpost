...
export class OneClass extends PropertiesMixin(HTMLElement) {
    ...
    _firstRendered() {
        ...
        if(!this.visible || this.visible === "false") {this.style.display = "none";
        console.log('here invisible');
    }
    }
    ...
    // getOnline(path) {//you can only await inside async func.
    //     return new Promise(resolve => {
    //         firestore.doc(path).get().then((doc) => {
    //             if (doc.exists) {resolve(doc.data());} 
    //             else {console.log("No such document!"); resolve(undefined);}
    //         }).catch((error) => {
